package com.webapplication.test.screenshot;
...
public class TakeScreenShot {
	...
	void testLogin() throws IOException {
		...
		assertEquals("You can't log in at the moment", errorMsg.getText());
		
		WebElement errorMsg2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"error_box\"]/div[2]")));
		assertEquals("To help keep your account safe, we've temporarily locked it. Before you try logging in again, check your login info and make sure that you're using your usual device on a secure network.", errorMsg2.getText());
	...
	private void takeScreeShot(String filename) throws IOException {
		...
		FileHandler.copy(src,new File("/D://upload/" +filename));
	}
